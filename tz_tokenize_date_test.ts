...
Deno.test('tzTokenizeDate America/New_York DST', () => {
...
Deno.test('tzTokenizeDate America/New_York', () => {
  const result = tzTokenizeDate(new Date('2021-11-13T12:15:30Z'), 'America/New_York')
  assertEquals(result, { year: 2021, month: 11, day: 13, hour: 7, minute: 15, second: 30 })
})